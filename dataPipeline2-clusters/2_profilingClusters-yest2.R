...
top10 <- read.csv("https://mvtec-group2.s3-eu-west-1.amazonaws.com/finaldata/preprocess/B_top10data_yest2.csv") # S3 !!!! Rebecca
...
write.csv(g1_pred_df_result, file = "C-top10Cluster1Pred-yest2.csv", row.names = FALSE)  # S3 !!!! Rebecca
...
# Export predictions for each cluster
write.csv(g2_pred_df_result, file = "C-top10Cluster2Pred-yest2.csv", row.names = FALSE)  # S3 !!!! Rebecca
...
# Export predictions for each cluster
write.csv(g3_pred_df_result, file = "C-top10Cluster3Pred-yest2.csv", row.names = FALSE)  # S3 !!!! Rebecca
...
# Export predictions for each cluster
write.csv(g4_pred_df_result, file = "C-top10Cluster4Pred-yest2.csv", row.names = FALSE)  # S3 !!!! Rebecca
...
# Export predictions for each cluster
write.csv(g5_pred_df_result, file = "C-top10Cluster5Pred-yest2.csv", row.names = FALSE)  # S3 !!!! Rebecca
